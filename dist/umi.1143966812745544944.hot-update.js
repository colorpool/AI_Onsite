globalThis.makoModuleHotUpdate('src/.umi/umi.ts?hmr', {
    modules: {
        "src/app.tsx": function(module, exports, __mako_require__) {
            ...
            var _user = __mako_require__("src/mock/user.ts");
            ...
            async function getInitialState() {
                const fetchUserInfo = async ()=>{
                    try {
                        const msg = await (0, _user.currentUser)({
    ...
    runtime._h = '18383439825972263953';
...
//# sourceMappingURL=umi.1143966812745544944.hot-update.js.map