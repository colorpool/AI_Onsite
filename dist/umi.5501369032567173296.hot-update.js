globalThis.makoModuleHotUpdate('src/.umi/umi.ts?hmr', {
    modules: {
        "src/app.tsx": function(module, exports, __mako_require__) {
            ...
            var _useMenuState = __mako_require__("src/hooks/useMenuState.ts");
            ...
            const layout = ({ initialState, setInitialState })=>{
                ...
                _s();
                // 使用自定义 hook 管理菜单状态
                const { openKeys, handleOpenChange } = (0, _useMenuState.useMenuState)();
                return {
                    ...
                    menuProps: {
                        ...
                        onOpenChange: (openKeys)=>{
                            ...
                            if (latestOpenKey) // 这里可以通过状态管理来控制 openKeys
                    ...
                    menuFooterRender: ()=>/*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_components.AvatarDropdown, {
                                    children: /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)("div", {
                                        style: {
                                            display: 'flex',
                                            alignItems: 'center',
                                ...
                                /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_components.SelectLang, {}, "unique-select-lang", false, {
                                    fileName: "src/app.tsx",
                                    lineNumber: 179,
                                    columnNumber: 9
                                }, this)
            ...
            _s(layout, "haD+ERX8WEimtP7lGHWi1kGH/b4=", false, function() {
                return [
                    _useMenuState.useMenuState
                ];
            });
            const request = {
...
//# sourceMappingURL=umi.5501369032567173296.hot-update.js.map