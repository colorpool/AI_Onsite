globalThis.makoModuleHotUpdate('src/.umi/umi.ts?hmr', {
        ...
        "src/app.tsx": function(module, exports, __mako_require__) {
            ...
            async function getInitialState() {
                try {
                    ...
                    console.log('Current user loaded:', currentUser === null || currentUser === void 0 ? void 0 : currentUser.name);
                    return {
                        fetchUserInfo,
                        currentUser,
                    ...
                    return {
                        fetchUserInfo: async ()=>(0, _mockData.getMockCurrentUser)(),
                        currentUser: (0, _mockData.getMockCurrentUser)(),
                        settings: _defaultSettings.default
                    };
                }
            }
            ...
            const request = {
                baseURL: (0, _env.isProduction)() ? '' : 'https://proapi.azurewebsites.net',
    ...
    runtime._h = '14036812443825371033';
...
//# sourceMappingURL=umi.16762675363996011393.hot-update.js.map